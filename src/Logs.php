...
class Logs
{
     ...
     * 
     * @param [type] $logPath        初始化日志记录的路径
     * @param string $logSaveFileApp 保存的文件名
     * @param string $logSystem      系统名
     */
    private function __construct($logPath, $logSaveFileApp='', $logSystem = '')
    {
        if (empty($logPath)) {
